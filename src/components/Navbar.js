...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      <Link to="/" className=" title block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-00 md:p-0 md:dark:text-blue-500" aria-current="page">Flowbite</Link>
